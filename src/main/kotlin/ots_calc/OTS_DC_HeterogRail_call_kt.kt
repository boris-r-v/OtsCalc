...
class OTS_DC_HeterogRail_call_kt internal constructor(// количество главных путей и ответвлений
  ...
  */
    ...
    var mps =
        arrayOf(doubleArrayOf()) // двумерный массив в каждой строке 5 элементов: 0 - номер пути начальной точки подключения, 1 - номер пути конечной точки подключения, 2 - координата начальной точки подключения км, 3 -координата конечной точки подключения км, 4 - сопротивление Ом.
