 ...
 * @param _cloud - облачность, доли единицы, 1 - сплошная облачность, 0 - ясно, (значение по-умолчанию 0.2)
 ...
 */
fun create_heat_transfer(_ext_temp: Double, _cloud: Double = 0.2, _wind: Double = 1.2, _sun_radiation: Double = 800.0): DT_heat_transfer {
...
/**
 * Фабрика создания ДТ
 *  Это метод должен в боевой версии заменен на метод извелечения параметров ДТ из базы данных.
