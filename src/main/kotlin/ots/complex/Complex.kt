...
interface Complex {
    ...
    /**
     * A string representation of a complex number (this) in the Form "2.5exp(32.0)" for example.
     * @param format This parameter affects the real an the imaginary part equally.
     * @param locale The locale determines e.g. whether a dot or a comma is output.
     */
    fun asStringExp(format: String = "", locale: Locale = Locale.getDefault()): String {
        return when (this) {
            NaN -> "NaN"
            INF -> "Infinity"
            else -> {
