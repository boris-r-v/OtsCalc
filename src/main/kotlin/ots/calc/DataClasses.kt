...
data class ComputingSettings(
    var isDirectSolver: Boolean = true,          // Истина, если прямой решатель для токов МПС, если ложь, то обратный
    ...
    var relativeConvergence: Double = 0.001,     //предел относительная сходимость среднего нааряжения на текущей и предудущей итерации в расчете наведенных междупутных напряжений, исп в callTracksUnionMesh
    var initCoefrlU: Real = 0.049.R,            // Начальное значение коэффициента k_rlU для наведенного напряжения с track. Этот параметр меняется с текущего до 1.0
    var stepCoefrlU: Real = 0.05.R,            // шаг возрастания коэффициента k_rlU для наведенного напряжения с track
