...
data class ComputingSettings(
    ...
    val maxRelativeIter: Int = 10,              //максимамльно число итераций в расчете сходимости наведенных междуапутных напряжений, исп в callTracksUnionMesh
    val relativeConvergence: Double = 0.01,     //предел относительная сходимость среднего нааряжения на текущей и предудущей итерации в расчете наведенных междупутных напряжений, исп в callTracksUnionMesh
